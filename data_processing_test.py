...
# Load the data
df = pd.read_csv('datasets/test/preprocessed_test_dataset.csv')
...
training_model = bm.BertopicTesting(df['punctuated_text'], trained_model_path="Bertopic/bertopic_model.pkl")
...
# Export the results
df.to_csv('datasets/test/processed_test_dataset.csv', index=False)